    ...
    <>
      ...
      <section className={`${config.bg} ${config.text} py-20 px-6`}>
        <div className="mx-auto max-w-[1440px]">
          ...
          <ArticleSignals slug={article.slug} title={article.title} vertical="tech" placement="top" />
        </div>
      </section>
      ...
      <section className="bg-cream py-16 px-6">
        <div className="mx-auto max-w-[1440px] grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12">
          ...
          <ArticleSignals slug={article.slug} title={article.title} vertical="tech" placement="bottom" />
